...
router.post("/questions", async (req, res) => {
  ...
  var mystr2 = mykey2.update(req.body.level, "utf8", "hex");
  ...
  question.link = `http://127.0.0.1:5500/questions.html?ans=${mystr}&level=${mystr2}`;
  await question.save();
  res.send(question);
});
...
router.post("/questiontype", async (req, res) => {
  const question = new Question(req.body);

  try{
  // question.link = `http://127.0.0.1:5500/questions.html?ans=${req.body.answer}&level=${mystr2}`;
  await question.save();
  res.send(question);
  }catch(e){
    res.send(e)
...
// console.log(mystr1)
    ...
    var mystr2 = mykey2.update(level, 'hex', 'utf8')
...
console.log(question.level)
    if(mystr1===question.answer && mystr2==question.level){
        // console.log('yes')
